...
public class About extends JFrame {
    ...
    About() {
        ...
        JLabel name = new JLabel("Developed By: Vikash Sharma");
        name.setBounds(70, 220, 550, 40);
        name.setFont(new Font("Tahoma", Font.BOLD, 30));
        add(name);
        
        JLabel rollno = new JLabel("Roll number: 0103EC201191");
        rollno.setBounds(70, 280, 550, 40);
        rollno.setFont(new Font("Tahoma", Font.PLAIN, 30));
        add(rollno);
        
        JLabel contact = new JLabel("Contact:vs8824394430@gmail.com");
