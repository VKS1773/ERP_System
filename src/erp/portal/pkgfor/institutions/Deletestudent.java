...
public class Deletestudent extends JFrame implements ActionListener{
    ...
    Deletestudent() {
       ...
       labelemail = new JLabel();
        ...
        JLabel lbladdate = new JLabel("Addmission date");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query="insert into paststudent values('"+name+"', '"+fname+"', '"+rollno+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+x+"', '"+xii+"', '"+aadhar+"', '"+course+"', '"+branch+"','"+addate+"','"+deletedate+"')";
                String query1="Delete from student where rollno='"+crollno.getSelectedItem()+"'";
                Conn con = new Conn();
                Conn con1=new Conn();
                con.s.executeUpdate(query);
                con1.s.executeUpdate(query1);
